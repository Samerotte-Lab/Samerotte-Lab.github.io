...
To study this map, we merge <b>high-throughput experiments in yeast</b> with computational and mathematical approaches. We pay attention to the way the impacts of some mutations change in similar ways across contexts, using these shared behaviors to <b>build predictive models</b>. By building accurate maps from genotype to phenotype, we gain power to predict the impacts of mutation, which is one of the most important goals of biology.